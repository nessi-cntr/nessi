#ifndef CNTR_BUBBLE_MOVING_DECL_H
#define CNTR_BUBBLE_MOVING_DECL_H
...
/*#########################################################################################
 ...
 #
 #   template GGA,GGB,GGC can be herm_matrix_moving,herm_matrix_timestep_moving,herm_matrix_timestep_moving_view
 #
...
void Bubble1_moving(int tc, GGC &C, int c1, int c2, GGA &A, GGA &Acc, int a1, int a2, GGB &B,
...
template <class GGC, class GGA, class GGB>
void Bubble1_moving(int tc, GGC &C, int c1, int c2, GGA &A, int a1, int a2, GGB &B, int b1,
             int b2);
...
template <class GGC, class GGA, class GGB>
void Bubble1_moving(int tc, GGC &C, GGA &A, GGA &Acc, GGB &B, GGB &Bcc);
 ...
 */
template <class GGC, class GGA, class GGB> 
void Bubble1_moving(int tc, GGC &C, GGA &A, GGB &B);
...
template <class GGC, class GGA, class GGB>
void Bubble2_moving(int tc, GGC &C, int c1, int c2, GGA &A, GGA &Acc, int a1, int a2, GGB &B,
             GGB &Bcc, int b1, int b2);
...
template <class GGC, class GGA, class GGB>
void Bubble2_moving(int tc, GGC &C, int c1, int c2, GGA &A, int a1, int a2, GGB &B, int b1,
             int b2);
...
template <class GGC, class GGA, class GGB>
void Bubble2_moving(int tc, GGC &C, GGA &A, GGA &Acc, GGB &B, GGB &Bcc);
 ...
 * > Two-time contour object in the \f$1\times 1\f$-Matrix form with the hermitian symmetry.
 */
template <class GGC, class GGA, class GGB> void Bubble2_moving(int tc, GGC &C, GGA &A, GGB &B);
}//namespace
