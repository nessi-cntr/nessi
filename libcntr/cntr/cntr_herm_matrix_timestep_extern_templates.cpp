...
namespace cntr {
  ...
  template void herm_matrix_timestep<double>::set_ret<Eigen::MatrixXcd>(int i, int j,Eigen::MatrixXcd &M);
  template void herm_matrix_timestep<double>::set_les<Eigen::MatrixXcd>(int i, int j,Eigen::MatrixXcd &M);
  template void herm_matrix_timestep<double>::set_tv<Eigen::MatrixXcd>(int i, int j,Eigen::MatrixXcd &M); 
  template void herm_matrix_timestep<double>::set_mat<Eigen::MatrixXcd>(int i,Eigen::MatrixXcd &M);

  template void herm_matrix_timestep<double>::get_les<Eigen::MatrixXcd>(int i, int j,Eigen::MatrixXcd &M);
  template void herm_matrix_timestep<double>::get_ret<Eigen::MatrixXcd>(int i, int j,Eigen::MatrixXcd &M);
  template void herm_matrix_timestep<double>::get_tv<Eigen::MatrixXcd>(int i, int mtau ,Eigen::MatrixXcd &M);
  template void herm_matrix_timestep<double>::get_mat<Eigen::MatrixXcd>(int i, Eigen::MatrixXcd &M);
  template void herm_matrix_timestep<double>::get_matminus<Eigen::MatrixXcd>(int i, Eigen::MatrixXcd &M);

  template void herm_matrix_timestep<double>::density_matrix<Eigen::MatrixXcd>(int tstp, Eigen::MatrixXcd &rho);
